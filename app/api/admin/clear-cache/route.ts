...
import { clearReputationCacheForDomain } from "@/lib/admin/tools-service";
...
export async function POST(request: Request) {
  ...
  console.info("[admin/clear-cache] action", { domain, adminEmail: actor.email });
  const deleted = await clearReputationCacheForDomain(actor, domain);
