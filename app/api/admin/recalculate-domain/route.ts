...
import { recalculateSingleDomain } from "@/lib/admin/tools-service";
...
export async function POST(request: Request) {
  ...
  console.info("[admin/recalculate-domain] action", { domain, adminEmail: actor.email });
  const summary = await recalculateSingleDomain(actor, domain);
