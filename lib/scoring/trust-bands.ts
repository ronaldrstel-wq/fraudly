...
const FEED_META_VIEW_BTN =
  "inline-flex h-[36px] shrink-0 items-center justify-center gap-1 whitespace-nowrap rounded-full border border-current bg-white px-3.5 text-[13px] font-bold leading-none";
