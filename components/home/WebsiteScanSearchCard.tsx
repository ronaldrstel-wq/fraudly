...
export type CheckFlowSearchCopy = {
  check: { urlPlaceholder: string; urlFieldLabel: string };
  scanProgress: { complete: string };
};
...
export function WebsiteScanSearchCard({
  ...
  const inputCommon = {
    ...
    placeholder: checkFlowSearch.check.urlPlaceholder
  };
          ...
          <div className="flex w-full min-w-0 flex-col gap-3 sm:flex-row sm:items-stretch">
            <div className="min-w-0 flex-1">
              <label htmlFor="fraudly-url-input" className="sr-only">
                {checkFlowSearch.check.urlFieldLabel}
              </label>
              <input
                {...inputCommon}
                ref={inputRef}
                aria-label={checkFlowSearch.check.urlFieldLabel}
                disabled={isScanning}
        ...
        >
          <div className="flex min-h-[3.25rem] items-center justify-center gap-3 sm:justify-start">
            ...
            <div className="min-w-0 text-left">
              <p className="text-sm font-semibold text-slate-900">{checkFlowSearch.scanProgress.complete}</p>
