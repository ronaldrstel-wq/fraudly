...
export function BlogHero({ article, readingMinutes }: BlogHeroProps) {
  ...
  return (
    <header className="fraudly-card overflow-hidden border-slate-100">
      <div className="border-b border-slate-100 bg-gradient-to-br from-blue-50/80 via-white to-violet-50/45 px-5 py-6 sm:px-8 sm:py-7">
        <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:gap-8">
          ...
          <div className="min-w-0 text-center sm:text-left">
            ...
            <p className="mt-3 text-xs font-semibold uppercase tracking-widest text-blue-700/90">
      ...
      <div className="p-6 sm:p-8">
        <h1 className="text-balance text-3xl font-bold tracking-tight text-slate-900 md:text-4xl">{article.title}</h1>
